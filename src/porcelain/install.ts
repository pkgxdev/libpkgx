import install, { type Logger as BaseLogger, ConsoleLogger as BaseConsoleLogger } from "../plumbing/install.ts"
import type { Installation, PackageSpecification } from "../types.ts"
import resolve, { type Resolution } from "../plumbing/resolve.ts"
